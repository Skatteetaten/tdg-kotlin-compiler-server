...
private const val tdssImport = "import no.skatteetaten.rst.tdss.person.person import no.skatteetaten.rst.tdss.enhet.enhet "
...
class ImportTest : BaseExecutorTest() {
    ...
    @Test
    fun `import tdss funksjoner som starter med skatt`() {
        val code = tdssImport + """
        fun main() {
            person {
                saldo
